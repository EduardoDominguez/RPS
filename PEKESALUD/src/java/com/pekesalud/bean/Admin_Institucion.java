 ...
 * @author ROGEPC
 */
public class Admin_Institucion {
    private int id_admin_institucion;
    ...
    public int getId_admin_institucion() {
        return id_admin_institucion;
    }

    public void setId_admin_institucion(int id_admin_institucion) {
        this.id_admin_institucion = id_admin_institucion;
    }
